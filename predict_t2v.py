...
#transformer_path    = "/home/lgk/2024/EasyAnimate-main/models/Diffusion_Transformer/EasyAnimateV2-XL-2-512x512/transformer/diffusion_pytorch_model.safetensors"
...
#vae_path            = "/home/lgk/2024/EasyAnimate-main/models/Diffusion_Transformer/EasyAnimateV2-XL-2-512x512/vae/diffusion_pytorch_model.safetensors"
#vae_path            = None
#lora_path           = None
lora_path           = "/home/lgk/2024/EasyAnimate-main/models/Personalized_Model/checkpoint-6400.safetensors"
...
prompt              = "hand, dorsal, vein, texture. The video is of high quality, and the view is very clear. High quality, masterpiece, best quality, highres, ultra-detailed, fantastic."
negative_prompt     = "The video is not of a high quality, it has a low resolution, and the audio quality is not clear. Strange motion trajectory, a poor composition and deformed video, low resolution, duplicate and ugly, rotating camera, blurry camera, shaking camera. Deformation, low-resolution, blurry, ugly, distortion. "  
guidance_scale      = 9.0
seed                = 43
